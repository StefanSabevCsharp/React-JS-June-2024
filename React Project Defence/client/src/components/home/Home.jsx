                ...
                <div className="mx-auto max-w-2xl py-16 sm:py-24 lg:py-32">
                    <div className="text-center">
                        ...
                        <p className="mt-6 text-lg leading-8 text-gray-600">
                            Step into style and comfort. Explore our curated selection of premium clothing that embraces elegance and everyday luxury. Find timeless pieces that effortlessly complement your wardrobe and express your unique sense of fashion.
                        </p>
